...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:archive</span></span></code></pre></div><h2 id="下一步" tabindex="-1">下一步 <a class="header-anchor" href="#下一步" aria-label="Permalink to &quot;下一步&quot;">​</a></h2><p>学习如何编写高质量的规范：</p><p>→ <a href="/ohmyopenAI-tutorial-hub/guide/openspec/writing-specs.html">编写高质量 Spec</a></p>`,79)])])}const g=a(l,[["render",e]]);export{r as __pageData,g as default};
