import{_ as a,o as n,c as i,ag as p}from"./chunks/framework.DbM0IBjv.js";const r=JSON.parse('{"title":"完整工作流","description":"","frontmatter":{},"headers":[],"relativePath":"guide/openspec/workflow.md","filePath":"guide/openspec/workflow.md","lastUpdated":1775571128000}'),l={name:"guide/openspec/workflow.md"};function e(t,s,h,k,d,o){return n(),i("div",null,[...s[0]||(s[0]=[p(`<h1 id="完整工作流" tabindex="-1">完整工作流 <a class="header-anchor" href="#完整工作流" aria-label="Permalink to &quot;完整工作流&quot;">​</a></h1><p>通过实际案例，学习 OpenSpec 从提案到归档的完整工作流。</p><h2 id="案例-添加用户评论功能" tabindex="-1">案例：添加用户评论功能 <a class="header-anchor" href="#案例-添加用户评论功能" aria-label="Permalink to &quot;案例：添加用户评论功能&quot;">​</a></h2><h3 id="背景" tabindex="-1">背景 <a class="header-anchor" href="#背景" aria-label="Permalink to &quot;背景&quot;">​</a></h3><p>你正在开发一个博客系统，需要添加文章评论功能：</p><ul><li>用户可以发表评论</li><li>支持回复评论</li><li>需要分页显示</li><li>需要权限控制</li></ul><h3 id="step-1-创建提案" tabindex="-1">Step 1：创建提案 <a class="header-anchor" href="#step-1-创建提案" aria-label="Permalink to &quot;Step 1：创建提案&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:propose（创建提案）</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;添加用户评论功能，支持发表评论、回复评论、分页显示&quot;</span></span></code></pre></div><p>AI 生成以下文档：</p><p><strong>proposal.md</strong></p><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;">## Why</span></span>
...
<span class="line"><span>/opsx:apply（应用规范）</span></span></code></pre></div><p>AI 开始执行任务：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>开始实现任务...</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">-</span><span style="--shiki-light:#24292E;--shiki-light-font-weight:bold;--shiki-dark:#E1E4E8;--shiki-dark-font-weight:bold;"> **THEN**</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 返回 400 错误，提示&quot;评论内容包含敏感词&quot;</span></span></code></pre></div><p>让 AI 继续：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:apply（应用规范）</span></span></code></pre></div><p>AI 读取更新后的规范，添加验证逻辑。</p><h3 id="step-5-验证实现" tabindex="-1">Step 5：验证实现 <a class="header-anchor" href="#step-5-验证实现" aria-label="Permalink to &quot;Step 5：验证实现&quot;">​</a></h3><p>实现完成后：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:verify</span></span></code></pre></div><p>AI 验证结果：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>验证结果：</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>建议：补充单元测试后再归档</span></span></code></pre></div><h3 id="step-6-补充测试" tabindex="-1">Step 6：补充测试 <a class="header-anchor" href="#step-6-补充测试" aria-label="Permalink to &quot;Step 6：补充测试&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:apply（应用规范）</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> task</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 2.4</span></span></code></pre></div><p>AI 补充单元测试：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>✓ 添加 CommentController 单元测试</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>可以归档！</span></span></code></pre></div><h3 id="step-7-归档" tabindex="-1">Step 7：归档 <a class="header-anchor" href="#step-7-归档" aria-label="Permalink to &quot;Step 7：归档&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:archive（归档变更）</span></span></code></pre></div><p>AI 执行归档：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>归档变更：</span></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 总计：2.5 小时</span></span></code></pre></div><h2 id="时间线回顾" tabindex="-1">时间线回顾 <a class="header-anchor" href="#时间线回顾" aria-label="Permalink to &quot;时间线回顾&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>T+0:00  /opsx:propose（创建提案） &quot;添加用户评论功能&quot;</span></span>
...
<span class="line"><span>       </span></span>
<span class="line"><span>T+0:45  /opsx:apply（应用规范）</span></span>
...
<span class="line"><span>       </span></span>
<span class="line"><span>T+1:45  /opsx:apply（应用规范）</span></span>
...
<span class="line"><span>       </span></span>
<span class="line"><span>T+2:45  /opsx:apply（应用规范） task 2.4</span></span>
<span class="line"><span>       补充测试</span></span>
<span class="line"><span>       </span></span>
<span class="line"><span>T+3:00  /opsx:verify</span></span>
<span class="line"><span>       全部通过</span></span>
<span class="line"><span>       </span></span>
<span class="line"><span>T+3:15  /opsx:archive（归档变更）</span></span>
<span class="line"><span>       归档完成</span></span></code></pre></div><h2 id="关键要点" tabindex="-1">关键要点 <a class="header-anchor" href="#关键要点" aria-label="Permalink to &quot;关键要点&quot;">​</a></h2><h3 id="_1-迭代调整是正常的" tabindex="-1">1. 迭代调整是正常的 <a class="header-anchor" href="#_1-迭代调整是正常的" aria-label="Permalink to &quot;1. 迭代调整是正常的&quot;">​</a></h3><p>不是一次就完美，发现遗漏及时更新规范。</p><h3 id="_2-规范是活的" tabindex="-1">2. 规范是活的 <a class="header-anchor" href="#_2-规范是活的" aria-label="Permalink to &quot;2. 规范是活的&quot;">​</a></h3><p>实现过程中可以修改 proposal、design、specs。</p><h3 id="_3-验证很重要" tabindex="-1">3. 验证很重要 <a class="header-anchor" href="#_3-验证很重要" aria-label="Permalink to &quot;3. 验证很重要&quot;">​</a></h3><p>/opsx:verify 确保实现符合规范。</p><h3 id="_4-归档沉淀知识" tabindex="-1">4. 归档沉淀知识 <a class="header-anchor" href="#_4-归档沉淀知识" aria-label="Permalink to &quot;4. 归档沉淀知识&quot;">​</a></h3><p>归档后的记录可供未来参考。</p><h2 id="常见流程变体" tabindex="-1">常见流程变体 <a class="header-anchor" href="#常见流程变体" aria-label="Permalink to &quot;常见流程变体&quot;">​</a></h2><h3 id="变体-1-简单功能" tabindex="-1">变体 1：简单功能 <a class="header-anchor" href="#变体-1-简单功能" aria-label="Permalink to &quot;变体 1：简单功能&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:propose（创建提案）</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;修复登录按钮样式&quot;</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:apply（应用规范）</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:archive（归档变更）</span></span></code></pre></div><p>简单功能可以跳过复杂审查。</p><h3 id="变体-2-手动实现部分" tabindex="-1">变体 2：手动实现部分 <a class="header-anchor" href="#变体-2-手动实现部分" aria-label="Permalink to &quot;变体 2：手动实现部分&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:propose（创建提案）</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;添加复杂算法&quot;</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:apply（应用规范）</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> from</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 2.3</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # AI 只实现部分</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:archive（归档变更）</span></span></code></pre></div><h3 id="变体-3-分阶段实现" tabindex="-1">变体 3：分阶段实现 <a class="header-anchor" href="#变体-3-分阶段实现" aria-label="Permalink to &quot;变体 3：分阶段实现&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:propose（创建提案）</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;添加支付功能&quot;</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:apply（应用规范）</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> phase</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 1</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # 只实现第一阶段（基础功能）</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 测试上线</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:apply（应用规范）</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> phase</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 2</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # 实现第二阶段（高级功能）</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/opsx:archive（归档变更）</span></span></code></pre></div><h2 id="下一步" tabindex="-1">下一步 <a class="header-anchor" href="#下一步" aria-label="Permalink to &quot;下一步&quot;">​</a></h2><p>学习如何编写高质量的规范：</p><p>→ <a href="/ohmyopenAI-tutorial-hub/guide/openspec/writing-specs">编写高质量 Spec</a></p>`,79)])])}const g=a(l,[["render",e]]);export{r as __pageData,g as default};
