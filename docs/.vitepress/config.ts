...
const enGuideSidebar = [
  ...
  },
  {
    ...
    collapsed: false,
    items: [
      { text: 'Testing Infrastructure', link: '/guide/harness/intro' },
      { text: 'Writing Tests', link: '/guide/harness/writing-tests' },
      { text: 'Evaluators', link: '/guide/harness/evaluators' },
      { text: 'Mock Server', link: '/guide/harness/mock-server' },
      { text: 'Practice', link: '/guide/harness/practice' },
      { text: 'Best Practices', link: '/guide/harness/best-practices' },
      { text: 'Feedback Loop', link: '/guide/harness/feedback-loop' },
      { text: 'Entropy Management', link: '/guide/harness/entropy' },
    ],
  },
  {
    text: 'OMO Workflow',
